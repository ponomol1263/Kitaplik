...
import com.codeandmania.kitaplik.adapters.RecyclerViewAdapter;
import com.codeandmania.kitaplik.utils.Book;
        ...
        final JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, key.toString(), null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        String title ="";
                        String author ="";
                        String publishedDate = "Bulunamadı";
                        String description = "Açıklama yok";
                        int pageCount = 1000;
                        String categories = "Kategori mevcut değil";
                        String buy ="";

                        String price = "Satılık Değil";
                        try {
                            ...
                            for (int i = 0 ; i< items.length() ;i++){
                                ...
                                mAdapter = new RecyclerViewAdapter(BookList.this , mBooks);

package com.codeandmania.kitaplik.network;

import com.codeandmania.kitaplik.network.movies.Movie;
import com.codeandmania.kitaplik.network.movies.MovieCastsOfPersonResponse;
import com.codeandmania.kitaplik.network.movies.MovieCreditsResponse;
import com.codeandmania.kitaplik.network.movies.NowShowingMoviesResponse;
import com.codeandmania.kitaplik.network.movies.PopularMoviesResponse;
import com.codeandmania.kitaplik.network.movies.SimilarMoviesResponse;
import com.codeandmania.kitaplik.network.movies.TopRatedMoviesResponse;
import com.codeandmania.kitaplik.network.movies.UpcomingMoviesResponse;
import com.codeandmania.kitaplik.network.people.Person;
import com.codeandmania.kitaplik.network.tvshows.AiringTodayTVShowsResponse;
import com.codeandmania.kitaplik.network.tvshows.OnTheAirTVShowsResponse;
import com.codeandmania.kitaplik.network.tvshows.PopularTVShowsResponse;
import com.codeandmania.kitaplik.network.tvshows.SimilarTVShowsResponse;
import com.codeandmania.kitaplik.network.tvshows.TVCastsOfPersonResponse;
import com.codeandmania.kitaplik.network.tvshows.TVShow;
import com.codeandmania.kitaplik.network.tvshows.TVShowCreditsResponse;
import com.codeandmania.kitaplik.network.tvshows.TopRatedTVShowsResponse;
...
public interface ApiInterface {
    ...
    Call<com.codeandmania.kitaplik.network.movies.GenresList> getMovieGenresList(@Query("api_key") String apiKey);
    ...
    @GET("genre/tv/list")
    Call<com.codeandmania.kitaplik.network.tvshows.GenresList> getTVShowGenresList(@Query("api_key") String apiKey);
